 ...
 * constructor
 */
HTTPClient_Custom::HTTPClient_Custom()
{
}
 ...
 * @return success bool
 */
bool HTTPClient_Custom::begin(WiFiClient &client, String url) {
#ifdef HTTPCLIENT_1_1_COMPATIBLE
    if(_tcpDeprecated) {
 ...
 * @return success bool
 */
bool HTTPClient_Custom::begin(WiFiClient &client, String host, uint16_t port, String uri, bool https)
{
#ifdef HTTPCLIENT_1_1_COMPATIBLE
    if(_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
...
#ifdef HTTPCLIENT_1_1_COMPATIBLE
bool HTTPClient_Custom::begin(String url, const char* CAcert)
{
 ...
 * @param url String
 */
bool HTTPClient_Custom::begin(String url)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
...
bool HTTPClient_Custom::beginInternal(String url, const char* expectedProtocol)
{
...
#ifdef HTTPCLIENT_1_1_COMPATIBLE
bool HTTPClient_Custom::begin(String host, uint16_t port, String uri)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
...
bool HTTPClient_Custom::begin(String host, uint16_t port, String uri, const char* CAcert)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
...
bool HTTPClient_Custom::begin(String host, uint16_t port, String uri, const char* CAcert, const char* cli_cert, const char* cli_key)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
 ...
 */
void HTTPClient_Custom::end(void)
{
    disconnect(false);
    clear();
}
 ...
 */
void HTTPClient_Custom::disconnect(bool preserveClient)
{
    if(connected()) {
 ...
 */
bool HTTPClient_Custom::connected()
{
    if(_client) {
 ...
 * @param reuse bool
 */
void HTTPClient_Custom::setReuse(bool reuse)
{
    _reuse = reuse;
}
 ...
 */
void HTTPClient_Custom::setUserAgent(const String& userAgent)
{
 ...
 */
void HTTPClient_Custom::setAuthorization(const char * user, const char * password)
{
    if(user && password) {
        String auth = user;
        auth += ":";
 ...
 */
void HTTPClient_Custom::setAuthorization(const char * auth)
{
    if(auth) {
 ...
 */
void HTTPClient_Custom::setAuthorizationType(const char * authType)
{
    if(authType) {
 ...
 */
void HTTPClient_Custom::setConnectTimeout(int32_t connectTimeout)
{
 ...
 */
void HTTPClient_Custom::setTimeout(uint16_t timeout)
{
    _tcpTimeout = timeout;
    if(connected()) {
 ...
 * @param use
 */
void HTTPClient_Custom::useHTTP10(bool useHTTP10)
{
 ...
 * @return http code
 */
int HTTPClient_Custom::POST(uint8_t * payload, size_t size)
{
    return sendRequest("POST", payload, size);
}

int HTTPClient_Custom::POST(String payload)
{
 ...
 * @return http code
 */
int HTTPClient_Custom::PATCH(uint8_t * payload, size_t size)
{
    return sendRequest("PATCH", payload, size);
}

int HTTPClient_Custom::PATCH(String payload)
{
 ...
 * @return http code
 */
int HTTPClient_Custom::PUT(uint8_t * payload, size_t size) {
    return sendRequest("PUT", payload, size);
}

int HTTPClient_Custom::PUT(String payload) {
 ...
 * @return
 */
int HTTPClient_Custom::sendRequest(const char * type, String payload)
{
 ...
 */
int HTTPClient_Custom::sendRequest(const char * type, uint8_t * payload, size_t size)
{
    int code;
    bool redirect = false;
 ...
 * @return -1 if no info or > 0 when Content-Length is set by server
 */
int HTTPClient_Custom::sendRequest(const char * type, Stream * stream, size_t size)
{
 ...
 * @return -1 if no info or > 0 when Content-Length is set by server
 */
int HTTPClient_Custom::getSize(void)
{
    return _size;
}
 ...
 * @return WiFiClient
 */
WiFiClient& HTTPClient_Custom::getStream(void)
{
    if (connected()) {
        return *_client;
    }
 ...
 * @return WiFiClient*
 */
WiFiClient* HTTPClient_Custom::getStreamPtr(void)
{
    if(connected()) {
        return _client;
    }
 ...
 */
int HTTPClient_Custom::writeToStream(Stream * stream)
{
 ...
 * @return String
 */
String HTTPClient_Custom::getString(void)
{
 ...
 * @return String
 */
String HTTPClient_Custom::errorToString(int error)
{
    switch(error) {
 ...
 * @param first
 */
void HTTPClient_Custom::addHeader(const String& name, const String& value, bool first, bool replace)
{
...
void HTTPClient_Custom::collectHeaders(const char* headerKeys[], const size_t headerKeysCount)
{
...
String HTTPClient_Custom::header(const char* name)
{
    for(size_t i = 0; i < _headerKeysCount; ++i) {
...
String HTTPClient_Custom::header(size_t i)
{
...
String HTTPClient_Custom::headerName(size_t i)
{
    if(i < _headerKeysCount) {
...
int HTTPClient_Custom::headers()
{
    return _headerKeysCount;
}

bool HTTPClient_Custom::hasHeader(const char* name)
{
    for(size_t i = 0; i < _headerKeysCount; ++i) {
 ...
 */
bool HTTPClient_Custom::connect(void)
{
    if(connected()) {
        if(_reuse) {
 ...
 * @return status
 */
bool HTTPClient_Custom::sendHeader(const char * type)
{
    if(!connected()) {
        return false;
    }
 ...
 */
int HTTPClient_Custom::handleHeaderResponse()
{
 ...
 */
int HTTPClient_Custom::writeToStreamDataBlock(Stream * stream, int size)
{
    int buff_size = HTTP_TCP_BUFFER_SIZE;
    int len = size;
    int bytesWritten = 0;
 ...
 * @return error
 */
int HTTPClient_Custom::returnError(int error)
{
    if(error < 0) {
...
void HTTPClient_Custom::setFollowRedirects(followRedirects_t follow)
{
    _followRedirects = follow;
}

void HTTPClient_Custom::setRedirectLimit(uint16_t limit)
{
 ...
 * @param url
 */
bool HTTPClient_Custom::setURL(const String& url)
{
...
const String &HTTPClient_Custom::getLocation(void)
{
    return _location;
}

void HTTPClient_Custom::setCookieJar(CookieJar* cookieJar)
{
    _cookieJar = cookieJar;
}

void HTTPClient_Custom::resetCookieJar()
{
    _cookieJar = nullptr;
}

void HTTPClient_Custom::clearAllCookies()
{
    if (_cookieJar) _cookieJar->clear();
}

void HTTPClient_Custom::setCookie(String date, String headerValue)
{
    if (!_cookieJar)
    {
        return;
...
bool HTTPClient_Custom::generateCookieString(String *cookieString)
{
    time_t now_local = time(NULL);
    time_t now_gmt = mktime(gmtime(&now_local));
